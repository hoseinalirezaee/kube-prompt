...
```
wget https://github.com/hoseinalirezaee/kube-prompt/releases/download/v2.5.2/kube-prompt_v2.5.2_darwin_amd64.zip
unzip kube-prompt_v2.5.2_darwin_amd64.zip
chmod +x kube-prompt
...
```
wget https://github.com/hoseinalirezaee/kube-prompt/releases/download/v2.5.2/kube-prompt_v2.5.2_darwin_arm64.zip
unzip kube-prompt_v2.5.2_darwin_arm64.zip
chmod +x kube-prompt
sudo mv ./kube-prompt /usr/local/bin/kube-prompt
```
...
```
wget https://github.com/hoseinalirezaee/kube-prompt/releases/download/v2.5.2/kube-prompt_v2.5.2_linux_amd64.zip
unzip kube-prompt_v2.5.2_linux_amd64.zip
chmod +x kube-prompt
sudo mv ./kube-prompt /usr/local/bin/kube-prompt
```
...
```
wget https://github.com/hoseinalirezaee/kube-prompt/releases/download/v2.5.2/kube-prompt_v2.5.2_linux_arm64.zip
unzip kube-prompt_v2.5.2_linux_arm64.zip
chmod +x kube-prompt
sudo mv ./kube-prompt /usr/local/bin/kube-prompt
```
...
```
wget https://github.com/hoseinalirezaee/kube-prompt/releases/download/v2.5.2/kube-prompt_v2.5.2_windows_amd64.zip
unzip kube-prompt_v2.5.2_windows_amd64.zip
```
...
```
wget https://github.com/hoseinalirezaee/kube-prompt/releases/download/v2.5.2/kube-prompt_v2.5.2_windows_arm64.zip
unzip kube-prompt_v2.5.2_windows_arm64.zip
```
